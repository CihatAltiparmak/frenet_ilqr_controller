...
| visualize_candidate_trajectories        | bool       | Default: false. Enable visualization of candidate trajectories generated by frenet_trajectory_planner|
| vehicle_type       | string | Default: "diff_drive_robot". vehicle type for ILQR to use as model (options : "diff_drive_robot", "omni_drive_robot")|
